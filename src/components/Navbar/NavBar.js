        ...
        <nav className={`fixed top-0 w-full sm:h-24 md:h-30 lg:h-36 xl:h-40 z-30 transition duration-300 ease-in-out mb-16 ${!top && 'bg-white shadow-lg'}`}>
            ...
            <div className="flex flex-row justify-center md:px-12 md:mx-12 sm:mx-12 items-center text-center font-semibold">
                ...
                <div className="group flex flex-col items-center">
                    ...
                    <div className={`fixed transition-transform duration-300 ease-in-out transit flex justify-center left-0 w-full h-auto rounded-md p-24 bg-white lg:hidden shadow-xl top-14 lg:-translate-x-4 ${  isOpen ? "block" : "hidden" } `}>
                        <div className='flex flex-col space-y-6 lg:-translate-x-4'>
                            <NavLinks />
                        </div>                                                
                    </div>
