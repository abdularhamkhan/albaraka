                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium">
                                    We streamline Amazon advertising, translating data into dollars. With campaigns designed for conversion, your path to profitability is crystal clear.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium">
                                    Credibility = conversions. Our creative team designs images and pages that reinforces the unique value of your products, while our SEO experts optimize listings for improved search visibility, leading to more clicks and, ultimately, increased sales.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium">
                                    Done with the DIY struggle and juggling multiple agencies? We’re the all-in-one solution for growth-focused brands ready to leave all of their Amazon needs up to the pros. Whether it’s listing optimization, SEO, PPC management, seasonality planning, or analytics, we handle it all.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            ...
                            <div>
                                ...
                                <p className="text-md font-medium">
                                    We provide Audits starting from as minimum as <span className='font-bold'>500$</span> depending upon client's needs. Our Amazon consultants provide expert guidance and support for businesses and individuals looking for Amazon Accounts Audits.
                                </p>
                            </div>
                        </div>
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold">We <span className='font-black'>Build Brands</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over 5 years OF experience in AMAZON BRAND BUILDING & AMAZON ACCOUNT MANAGEMENT, we have deep understanding of the latest Amazon trends and solutions, we provide customized strategies to help you improve your operations, reduce costs, and increase efficiency.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We can collaborate with your existing tech team to redefine the existing sales goals or redesign Amazon PPC compaigns strategy that suits your budget and returns maximum reach.</p>
                            </div>
                        </div>
                    </div>
                </div>
